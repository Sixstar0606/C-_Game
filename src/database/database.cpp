...
namespace GTServer {
    ...
    bool Database::Connect() {
        ...
        try {
            ...
            m_config_table = new ConfigTable(m_connection);
        }
    ...
    void* Database::GetTable_Interface(const eDatabaseTable& table) {
        switch (table) {
            case DATABASE_PLAYER_TABLE: return m_player_table;
            case DATABASE_WORLD_TABLE: return m_world_table;
            case DATABASE_CONFIG_TABLE: return m_config_table;
            default:
                return nullptr;
        }
        return nullptr;
